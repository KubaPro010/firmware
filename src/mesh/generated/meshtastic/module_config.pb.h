...
typedef struct _meshtastic_ModuleConfig_NodeModAdminConfig {
 ...
 0 means firmware default (5 => 0.5 cost units). */
    ...
    /* To pass MQTT directly, we don't look at the message, just broadcast it
 You can run a virtual node though this */
    bool mqtt_passthrough;
...
#define meshtastic_ModuleConfig_NodeModAdminConfig_mqtt_passthough_tag 45
...
X(a, STATIC,   SINGULAR, BOOL,     mqtt_passthrough,  45)
